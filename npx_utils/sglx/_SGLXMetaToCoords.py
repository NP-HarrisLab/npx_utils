...
def readMeta(metaPath):
    metaDict = {}
    # if metaPath is not pathlib, convert
...
def MetaToCoords(
    ...
    if "snsGeomMap" in meta:
        [nShank, shankWidth, shankPitch, shankInd, xCoord, yCoord, connected] = (
            geomMapToGeom(meta)
        )
    else:
        [nShank, shankWidth, shankPitch, shankInd, xCoord, yCoord, connected] = (
